    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Card>
                    <H4 className="text-slate-700">Informações do Cliente</H4>
                    <hr className="mb-3" />
                    <Row>
                        <Column size={6}>
                            <Text
                                ...
                                id="cliente"
                                {...register("cliente", {
                                    ...createValidationRule('Nome do Cliente', "required", true)
                                })}
                                errors={errors}
                            />
                        </Column>
                    ...
                    <Row>
                        <Column size={6}>
                            <Select
                                ...
                                id="categoria"
                                data={[
                                    { key: "mensalidade", value: "Mensalidade" },
